...
const Footer = () => {
  return (
    <footer className="bg-[#0F172A] max-lg:pt-10 max-lg:pb-4  w-full ">
      <div className="flex justify-center lg:py-16 pb-6 px-6 lg:px-20">
        <img className="max-w-44" src={WhiteLogo} alt="Minucia logo" />
      </div>
      <div className="flex max-lg:flex-col text-center w-full flex-1 justify-center items-center lg:px-20 px-6 border-t-2 border-[#334155] text-zinc-400 py-2">
        <div>
          <p>
